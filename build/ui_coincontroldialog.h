...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 LCV"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 LCV"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 LCV"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 LCV"));
