...
public:
    ...
    QLabel *label_11;
    QLabel *LCVBalanceLabel;
    QLabel *label_12;
    QLabel *BitcoinBalanceLabel;
    QSpacerItem *horizontalSpacer_4;
    QLabel *label_13;
    QLabel *LCVAvailableLabel_2;
    QLabel *label_15;
    QLabel *BitcoinAvailableLabel;
    QLabel *label_14;
    QLabel *LCVPendingLabel;
    QLabel *label_31;
    ...
    void setupUi(QDialog *tradingDialog)
    {
        ...
        LCVAvailableLabel = new QLabel(BuyTab);
        LCVAvailableLabel->setObjectName(QStringLiteral("LCVAvailableLabel"));
        QPalette palette1;
        ...
        LCVAvailableLabel->setPalette(palette1);
        LCVAvailableLabel->setFont(font3);
        LCVAvailableLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);

        horizontalLayout->addWidget(LCVAvailableLabel);

        labelLCV = new QLabel(BuyTab);
        labelLCV->setObjectName(QStringLiteral("labelLCV"));
        labelLCV->setFont(font3);

        horizontalLayout->addWidget(labelLCV);
        ...
        UnitsInputLCV = new QLineEdit(BuyTab);
        UnitsInputLCV->setObjectName(QStringLiteral("UnitsInputLCV"));
        UnitsInputLCV->setMinimumSize(QSize(0, 0));
        UnitsInputLCV->setFont(font5);

        gridLayout_6->addWidget(UnitsInputLCV, 4, 9, 1, 1);
        ...
        BuyLCV = new QPushButton(BuyTab);
        BuyLCV->setObjectName(QStringLiteral("BuyLCV"));

        gridLayout_6->addWidget(BuyLCV, 7, 3, 1, 1);

        SellLCVBTN = new QPushButton(BuyTab);
        SellLCVBTN->setObjectName(QStringLiteral("SellLCVBTN"));

        gridLayout_6->addWidget(SellLCVBTN, 7, 9, 1, 1);
        ...
        LCVDemand = new QLabel(BuyTab);
        LCVDemand->setObjectName(QStringLiteral("LCVDemand"));
        QFont font6;
        font6.setPointSize(8);
        LCVDemand->setFont(font6);
        LCVDemand->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout_6->addWidget(LCVDemand, 0, 1, 1, 5);

        LCVSupply = new QLabel(BuyTab);
        LCVSupply->setObjectName(QStringLiteral("LCVSupply"));
        LCVSupply->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout_6->addWidget(LCVSupply, 0, 9, 1, 3);
        ...
        BittrexLCVLabel = new QLabel(tab);
        BittrexLCVLabel->setObjectName(QStringLiteral("BittrexLCVLabel"));
        QPalette palette7;
        ...
        BittrexLCVLabel->setPalette(palette7);
        BittrexLCVLabel->setFont(font7);
        BittrexLCVLabel->setAutoFillBackground(false);
        BittrexLCVLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        horizontalLayout_8->addWidget(BittrexLCVLabel);
        ...
        LCVBalanceLabel = new QLabel(BalanceTab);
        LCVBalanceLabel->setObjectName(QStringLiteral("LCVBalanceLabel"));
        LCVBalanceLabel->setFont(font4);
        LCVBalanceLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(LCVBalanceLabel, 0, 3, 1, 1);
        ...
        LCVAvailableLabel_2 = new QLabel(BalanceTab);
        LCVAvailableLabel_2->setObjectName(QStringLiteral("LCVAvailableLabel_2"));
        LCVAvailableLabel_2->setFont(font4);
        LCVAvailableLabel_2->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(LCVAvailableLabel_2, 1, 3, 1, 1);
        ...
        LCVPendingLabel = new QLabel(BalanceTab);
        LCVPendingLabel->setObjectName(QStringLiteral("LCVPendingLabel"));
        LCVPendingLabel->setFont(font4);
        LCVPendingLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(LCVPendingLabel, 2, 3, 1, 1);
        ...
        LCVBalanceLabel->raise();
        LCVAvailableLabel_2->raise();
        LCVPendingLabel->raise();
    ...
    void retranslateUi(QDialog *tradingDialog)
    {
        ...
        label232_2->setText(QApplication::translate("tradingDialog", "LCV Available:", 0));
        LCVAvailableLabel->setText(QApplication::translate("tradingDialog", " 0.00000000 ", 0));
        labelLCV->setText(QApplication::translate("tradingDialog", " LCV", 0));
        Buy_Max_Amount->setText(QApplication::translate("tradingDialog", "Max", 0));
        label_4->setText(QApplication::translate("tradingDialog", "LCV", 0));
        Sell_Max_Amount->setText(QApplication::translate("tradingDialog", "Max", 0));
        label_22->setText(QApplication::translate("tradingDialog", "LCV", 0));
        ...
        BuyLCV->setText(QApplication::translate("tradingDialog", "Buy LCV", 0));
        SellLCVBTN->setText(QApplication::translate("tradingDialog", "Sell LCV", 0));
        ...
        LCVDemand->setText(QApplication::translate("tradingDialog", "Demand: 0.00000000 LCV", 0));
        LCVSupply->setText(QApplication::translate("tradingDialog", "Supply: 0.00000000 LCV", 0));
        ...
        label_32->setText(QApplication::translate("tradingDialog", "Amount in LCV:", 0));
        CSTotalLabel->setText(QApplication::translate("tradingDialog", " 0.00000000", 0));
        label_35->setText(QApplication::translate("tradingDialog", "LCV", 0));
        ...
        label_29->setText(QApplication::translate("tradingDialog", "LCV Balance:", 0));
        BittrexLCVLabel->setText(QApplication::translate("tradingDialog", " 0.00000000", 0));
        label_30->setText(QApplication::translate("tradingDialog", "LCV", 0));
        ...
        label_11->setText(QApplication::translate("tradingDialog", "LCV Balance:", 0));
        LCVBalanceLabel->setText(QApplication::translate("tradingDialog", "0.00000000", 0));
        ...
        label_13->setText(QApplication::translate("tradingDialog", "LCV Available:", 0));
        LCVAvailableLabel_2->setText(QApplication::translate("tradingDialog", "0.00000000", 0));
        ...
        label_14->setText(QApplication::translate("tradingDialog", "LCV Pending:", 0));
        LCVPendingLabel->setText(QApplication::translate("tradingDialog", "0.00000000", 0));
        ...
        GenDepositBTN->setText(QApplication::translate("tradingDialog", "Generate LCV Coin Deposit Address", 0));
        ...
        label_34->setText(QApplication::translate("tradingDialog", "Withdraw LCV:", 0));
