...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About LocavoreCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>LocavoreCoin</b> version", 0));
...
"Copyright \302\251 2018 The LocavoreCoin developers", 0));
