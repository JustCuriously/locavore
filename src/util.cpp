...
int nAnonymizeLocavoreCoinAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\LocavoreCoin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\LocavoreCoin
    // Mac: ~/Library/Application Support/LocavoreCoin
    // Unix: ~/.locavore
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "locavore";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "locavore.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "locavored.pid"));
