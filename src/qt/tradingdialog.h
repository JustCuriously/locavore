...
private slots:
    ...
    QString BuyLCV(QString OrderType, double Quantity, double Rate);
    QString SellLCV(QString OrderType, double Quantity, double Rate);
